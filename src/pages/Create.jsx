...
export default function Create() {
    ...
    const handleCurrent = (selectedOptions) => {
        ...
        if (isLastQuestion) {
            ...
            //When having the final answers we can process them to create the restrictions string for the backend
            console.log("Final Answers:", finalAnswers);
            const restrictions = finalAnswers.map(ans => {
                return questions[ans.questionId].restrictionPreffix + ans.answers.join(", ") + questions[ans.questionId].restrictionSuffix
            })
                .join(" ");
            console.log("Restrictions String:", restrictions);
            // Here I should send 'restrictions' to the backend API that is on python
